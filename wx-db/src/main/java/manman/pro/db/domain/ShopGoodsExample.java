...
public class ShopGoodsExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addGalleryCriterion(String condition, Object value, String property) {
            ...
            galleryCriteria.add(new Criterion(condition, value, "manman.pro.db.mybatis.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addGalleryCriterion(String condition, String[] value1, String[] value2, String property) {
            ...
            galleryCriteria.add(new Criterion(condition, value1, value2, "manman.pro.db.mybatis.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }
    ...
    public static class Criteria extends GeneratedCriteria {
        ...
        public Criteria andLogicalDeleted(boolean deleted) {
            return deleted ? andDeletedEqualTo(ShopGoods.IS_DELETED) : andDeletedNotEqualTo(ShopGoods.IS_DELETED);
        }
         ...
         * This interface corresponds to the database table shop_goods
         *
         * @mbg.generated
         * @project https://github.com/itfsw/mybatis-generator-plugin
         */
