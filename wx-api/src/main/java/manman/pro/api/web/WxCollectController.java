...
import manman.pro.db.service.ShopCollectService;
...
public class WxCollectController {
    ...
    public Object list(@LoginUser Integer userId, Integer typeId,
        ...
        List<ShopCollect> collectList = collectService.queryByType(userId, typeId, page, size);
    ...
    public Object addordelete(@LoginUser Integer userId, @RequestBody String body) {
        ...
        ShopCollect collect = collectService.queryByTypeAndValue(userId, typeId, valueId);
