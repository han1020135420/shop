...
import manman.pro.db.util.OrderHandleOption;
import manman.pro.db.util.OrderUtil;
...
public class WxOrderController {
    ...
    private String detailedAddress(ShopAddress shopAddress) {
        Integer provinceId = shopAddress.getProvinceId();
        Integer cityId = shopAddress.getCityId();
        Integer areaId = shopAddress.getAreaId();
        ...
        return fullRegion + " " + shopAddress.getAddress();
    }
    /**
     * 订单列表
     *
    ...
    public Object list(@LoginUser Integer userId, Integer showType,
        ...
        List<ShopOrder> orderList = orderService.queryByOrderStatus(userId, orderStatus);
    ...
    public Object submit(@LoginUser Integer userId, @RequestBody String body) {
        ...
        // 收货地址
        ShopAddress checkedAddress = addressService.findById(addressId);
        ...
        try {
            ...
            for (ShopCart checkGoods : checkedGoodsList) {
                ...
                ShopProduct product = productService.findById(productId);
