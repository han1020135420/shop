...
import manman.pro.api.service.UserInfoService;
import manman.pro.core.util.ResponseUtil;
import manman.pro.db.domain.ShopComment;
import manman.pro.db.service.ShopCommentService;
...
public class WxCommentController {
     ...
     */
    @PostMapping("post")
    public Object post(@LoginUser Integer userId, @RequestBody ShopComment comment) {
        if(userId == null){
    ...
    public Object list(Byte typeId, Integer valueId, Integer showType,
        ...
        List<ShopComment> commentList = commentService.query(typeId, valueId, showType, page, size);
        ...
        for(ShopComment comment : commentList){
