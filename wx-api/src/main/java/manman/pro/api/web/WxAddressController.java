...
import manman.pro.db.service.ShopAddressService;
...
public class WxAddressController {
    ...
    public Object list(@LoginUser Integer userId) {
        ...
        for(ShopAddress address : addressList){
    ...
    public Object detail(@LoginUser Integer userId, Integer id) {
        ...
        ShopAddress address = addressService.findById(id);
        if(address == null){
